...
if (isset($_GET['cloturer'])) {
    ...
    if (mysqli_query($cnxBDD, $sql)) {
        ...
        echo "Erreur lors de la mise à jour des fiches de frais : " . mysqli_error($cnxBDD);
    }
}
                ...
                foreach ($visiteurs as $visiteur) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="?cloturer=<?= htmlspecialchars($visiteur['id'], ENT_QUOTES, 'UTF-8') ?>" onclick="return confirm('Clôturer toutes les fiches de frais en cours ?');">Clôturer</a>
                        </td>
                    </tr>
                <?php
                }
